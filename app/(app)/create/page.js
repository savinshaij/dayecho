                ...
                {preview && (
                  <div className="relative group">
                    <img
                      src={preview}
                      alt="Preview"
                      className="w-full h-auto max-h-32 object-contain rounded-lg border border-bgs"
                    />
                    <button
                      type="button"
                      onClick={() => {
          ...
          >
            <div className="space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                <button
                  onClick={() => setIsOpen(false)}
                  className="flex-1 py-2 bg-bgs text-white rounded-lg hover:bg-bgs/80 transition-colors"
                >
                  Create Another
                </button>
                <Link href="/home" className="flex-1">
                  <button className="w-full py-2 bg-primary text-gray-900 font-medium rounded-lg hover:bg-primary/90 transition-colors">
                    Go to Home
                  </button>
                </Link>
              </div>
