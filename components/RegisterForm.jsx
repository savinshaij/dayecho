      ...
      <div className="flex w-full  justify-center items-center max-w-sm mx-auto overflow-hidden  rounded-lg   lg:max-w-4xl">
          ...
          <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
              <div className="flex justify-center mx-auto py-3">
                  <h3 className=' text-3xl font-poppins font-semibold text-primary'> Register</h3>
              </div>
              ...
              <form onSubmit={handleSubmit}>
                  ...
                  <div className="flex items-center justify-between mt-4">
                      ...
                      <a href="#" className="text-xs text-center text-textc uppercase  hover:underline">or register
                          with email</a>
                  ...
                  <div className="mt-4">
                      ...
                      <input  className="block w-full px-4 py-2 text-white bg-[#38414b] border rounded-lg    focus:border-orange-400 focus:ring-opacity-40  focus:outline-none focus:ring focus:ring-blue-300"
                        value={password} 
            ...
            <div className="text-red-600 text-[16px] mb-4">
              {error}
                  ...
                  <div className="flex items-center justify-between mt-4">
                      ...
                      <Link href="/login" className="text-xs text-textc uppercase  hover:underline">or Login</Link>
