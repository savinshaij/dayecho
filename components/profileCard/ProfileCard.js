    ...
    return (
        ...
        <div className=" py-5  md:mx-48 md:items-center  flex flex-col  px-4 rounded-2xl bg-bgp border-[1px] border-[#fff2] text-gray-100">
            <div className="flex space-y-0 space-x-6 flex-row md:gap-2 ">
                ...
                <a rel="noopener noreferrer" href="https://github.com/savinshaij" aria-label="GitHub" className="p-2 rounded-mdtext-gray-100 hover:text-violet-400">
                ...
                <Link rel="noopener noreferrer" href="https://www.instagram.com/_savin_shaij_/" aria-label="Instagram" className="p-2 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
                    <FaInstagram/>
                </Link>
                <Link rel="noopener noreferrer" href="https://www.linkedin.com/in/savin-p-s-652665275/" aria-label="Linkedin" className="p-2 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
                   <FaLinkedin/>
                </Link>
                <Link rel="noopener noreferrer" href="mailto:savinshaij19@gmail.com" aria-label="Email" className="p-2 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
